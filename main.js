...
(function(){
  ...
  function go(i){
    ...
    countEl.textContent=String(cur+1).padStart(2,'0')+' / '+String(slides.length).padStart(2,'0');
  }

  document.getElementById('pPrev').addEventListener('click',()=>go(cur-1));
  document.getElementById('pNext').addEventListener('click',()=>go(cur+1));
